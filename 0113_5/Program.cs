...
//### 💻 종합 예제
    ...
    class RPGCharacter
    {
        ...
        {
            Console.WriteLine("╔═══════════════════════════════════════════╗");
            Console.WriteLine($"║  {name} - {job,-24}        ║");
            Console.WriteLine($"║  레벨: {level,-35}║");
            Console.WriteLine("╠═══════════════════════════════════════════╣");
            Console.WriteLine($"║  HP: {hp}/{maxHP,-33}║");
            Console.WriteLine($"║  MP: {mp}/{maxMP,-34}║");
            Console.WriteLine($"║  공격력: {attack,-33}║");
            Console.WriteLine($"║  방어력: {defense,-33}║");
            Console.WriteLine($"║  경험치: {exp}/100{"",-28}║");
            Console.WriteLine($"║  골드: {gold,-35}║");
            Console.WriteLine($"╚═══════════════════════════════════════════╝");
        }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 캐릭터 생성
            RPGCharacter player = new RPGCharacter("바우", "궁수");
            RPGCharacter enemy = new RPGCharacter("주노", "전사");
